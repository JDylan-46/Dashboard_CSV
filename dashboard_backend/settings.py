...
# Configuración para archivos más grandes
FILE_UPLOAD_MAX_MEMORY_SIZE = 50 * 1024 * 1024  # 50 MB en memoria
DATA_UPLOAD_MAX_MEMORY_SIZE = 50 * 1024 * 1024  # 50 MB máximo
DATA_UPLOAD_MAX_NUMBER_FIELDS = 10000  # Más campos permitidos

# Para archivos temporales grandes
